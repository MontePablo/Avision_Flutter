...
import 'package:avision/data_models/studentIdRequest.dart';
...
import 'package:avision/repositories/subjects_practice_examstudypractice_repo.dart';
...
class PracticeExamstudypracticeViewmodel with ChangeNotifier{
  bool isLoading=false;
  SubjectsPracticeExamstudypracticeResponse? dataSubjectlist;
 final subjectRepo=SubjectsPracticeExamstudypracticeRepo();
  void fetchSubjects(BuildContext context,StudentIdRequest data) async{
    setLoading(true);
    subjectRepo.fetch(data.toJson())
        .then((value) {
      setLoading(false);
      if(value!=null) {
        dataSubjectlist = SubjectsPracticeExamstudypracticeResponse.fromJson(value);
        notifyListeners();
      }
